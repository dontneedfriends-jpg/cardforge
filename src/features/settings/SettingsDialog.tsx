      ...
      <div className={styles.section}>
        ...
        <div className={styles.settingRow}>
          ...
          <div className={styles.settingControl}>
            <Dropdown
              value={fontSize}
              onOptionSelect={(_e, data) => setFontSize(data.optionValue as 'small' | 'medium' | 'large')}
              style={{ minWidth: 140 }}
            >
        ...
        <div className={styles.settingRow}>
          ...
          <div className={styles.settingControl}>
            <Dropdown
              value={density}
              onOptionSelect={(_e, data) => setDensity(data.optionValue as 'compact' | 'comfortable' | 'spacious')}
              style={{ minWidth: 140 }}
            >
        ...
        <div className={styles.settingRow}>
          ...
          <div className={styles.settingControl}>
            <Dropdown
              value={language}
              onOptionSelect={(_e, data) => setLanguage(data.optionValue ?? 'en')}
              style={{ minWidth: 140 }}
            >
        ...
        <div className={styles.settingRow}>
          ...
          <div className={styles.settingControl}>
            <Dropdown
              ...
              onOptionSelect={(_e, data) => setPreviewBackground(data.optionValue as 'checkerboard' | 'dark' | 'light')}
              style={{ minWidth: 140 }}
            >
